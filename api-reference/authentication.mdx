...
The Generative Calls API uses API keys to authenticate requests. You need to include your API key in the header of each request you make to the API.

## Obtaining an API Key

To obtain an API key:

1. Log in to your Generative Calls account at https://calls.generative.ro
...
```bash
curl -X GET "https://app.generative.ro/api/user/campaigns" \
