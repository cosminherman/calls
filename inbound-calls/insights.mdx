...
After an inbound call, Generative Calls provides transcripts, analytics, and possible automation triggers.
...
- In your Generative Calls dashboard, go to **Calls** or **History**.
