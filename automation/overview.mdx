...
description: "Learn about Generative Calls' built-in automation engine for creating workflows without coding"
---
...
Generative Calls includes an internal automation engine (similar to Zapier or Make) that lets you build flows—no coding required. For instance:
...
- **Triggers**: Events inside Generative Calls (e.g., "call ended," "inbound call context injection").
