---
title: "Costs"
description: "Generative Calls is a pay-as-you-go platform, you only pay for what you use."
---
...
- **Generative Calls costs**: These are the costs associated with the AI assistant handling the call
- **Carrier costs**: These are the costs associated with the carrier (telephone network) used to make the call

## Generative Calls costs
...
_Example: for a 30 seconds call to a number in the USA, you will be billed 1 minute x 0.01_